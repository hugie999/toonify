...
def main(page: ft.Page):
    ...
    while tokenpage.open == True:
        time.sleep(1)
    navigator = fletnav.VirtualFletNavigator(navigator_animation=fletnav.NavigatorAnimation(fletnav.NavigatorAnimation.FADE,fletnav.NavigatorAnimation.SMOOTHNESS_10))
